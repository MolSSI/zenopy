...
metadata = {
    ...
    "publication_date": {
        "required": True,
        "condition": None,
        "description": ("Date of publication in ISO8601 format (YYYY-MM-DD). "
    ...
    "license": {
        ...
        "description": ("The selected license applies to all files in this deposition, "
    ...
    "embargo_date": {
        ...
        "description": ("When the deposited files will be made automatically made "
        "publicly available by the system. Defaults to current date."),
    },
    "access_conditions": {
        "required": True,
        "condition": "'access_right' == 'restricted'",
        "description": ("Specify the conditions under which you grant users access "
    ...
    "doi": {
        "required": False,
        "condition": None,
        "description": ("Digital Object Identifier. Did a publisher already assign a "
    ...
    "prereserve_doi": {
        "required": False,
        "condition": None,
        "description": ("Set to true, to reserve a Digital Object Identifier (DOI). "
    ...
    "keywords": {
        "required": False,
        "condition": None,
        "description": ("Free form keywords for this deposition. "
    ...
    "related_identifiers": {
        "required": False,
        "condition": None,
        "description": ("Persistent identifiers of related publications and datasets. "
    ...
    "contributors": {
        "required": False,
        "condition": None,
        "description": ("The contributors of the deposition (e.g. editors, data curators, "
    ...
    "communities": {
        "required": False,
        "condition": None,
        "description": ("List of communities you wish the deposition to appear. The owner of the "
    ...
    "grants": {
        "required": False,
        "condition": None,
        "description": ("List of OpenAIRE-supported grants, which have funded the research for "
    ...
    "conference_title": {
        "required": False,
        "condition": None,
        "description": ("Title of conference (e.g. 20th International Conference on Computing "
    ...
    "conference_dates": {
        "required": False,
        "condition": None,
        "description": ("Dates of conference (e.g. 14-18 October 2013). "
        "Conference title or acronym must also be specified if this field is specified."),
    },
    "conference_place": {
        "required": False,
        "condition": None,
        "description": ("Place of conference in the format city, country (e.g. Amsterdam, The "
    ...
    "subjects": {
        "required": False,
        "condition": None,
        "description": ("Specify subjects from a taxonomy or controlled vocabulary. "
    ...
    "version": {
        "required": False,
        "condition": None,
        "description": ("Version of the resource. Any string will be accepted, "
    ...
    "language": {
        "required": False,
        "condition": None,
        "description": ("Specify the main language of the record as ISO 639-2 or 639-3 "
    ...
    "dates": {
        "required": False,
        "condition": None,
        "description": ("List of date intervals:\n"
